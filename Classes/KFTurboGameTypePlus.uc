...
// Variables to hold game settings
...
defaultproperties
{
    ...
    DTFStartingCash = INITIAL_CASH
    DTFMinRespawnCash = INITIAL_CASH
    DTFStandardMaxZombiesOnce = STD_MAX_ZOMBIES
    DTFNextSpawnTime = SPAWN_TIME
    FakedPlayerHealth = FAKED_P_HEALTH
