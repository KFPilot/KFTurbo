//Killing Floor Turbo ExecuteMedium
//Distributed under the terms of the MIT License.
//For more information see https://github.com/KFPilot/KFTurbo.
class ExecuteMedium extends Emitter;
...
defaultproperties
{
    Begin Object Name=ExecuteMediumEmitter Class=SpriteEmitter
        ...
        StartLocationRange=(Y=(Min=84.000000,Max=84.000000))
        UseRotationFrom=PTRS_Offset
        StartSizeRange=(X=(Min=48.000000,Max=48.000000),Y=(Min=12.000000,Max=12.000000),Z=(Min=0.000000,Max=0.000000))
        ScaleSizeByVelocityMax=0.000000
        InitialParticlesPerSecond=5000.000000
        DrawStyle=PTDS_AlphaBlend
        Texture=Texture'KFTurboCardGame.Effects.Executed_D'
        StartVelocityRange=(Y=(Min=300.000000,Max=300.000000))
        VelocityLossRange=(X=(Min=8.000000,Max=8.000000),Y=(Min=8.000000,Max=8.000000),Z=(Min=8.000000,Max=8.000000))
        GetVelocityDirectionFrom=PTVD_StartPositionAndOwner
    End Object
    Emitters(0)=SpriteEmitter'ExecuteMediumEmitter'
