//Killing Floor Turbo RouletteEffect
//Distributed under the terms of the MIT License.
//For more information see https://github.com/KFPilot/KFTurbo.
class RouletteEffect extends Emitter;
...
simulated function PostNetBeginPlay()
{
    ...
    {
        PlayOwnedSound(Sound'Steamland_SND.SlotMachine_Win', SLOT_None, 4.f,, 5000.f);
    }
}
...
defaultproperties                                                                                                                             
{
    Begin Object Class=SpriteEmitter Name=RouletteSpriteEmitter
        ...
        AutoDestroy=true
    End Object
    Emitters(0)=SpriteEmitter'RouletteSpriteEmitter'
