//Killing Floor Turbo CheatDeathEffect
//Distributed under the terms of the MIT License.
//For more information see https://github.com/KFPilot/KFTurbo.
class CheatDeathEffect extends Emitter;
...
simulated function PostNetBeginPlay()
{
    ...
    {
        PlayOwnedSound(Sound'HillbillyHorrorSND.General.KF_GnomeHeaven', SLOT_None, 4.f,, 5000.f);
    }
}

defaultproperties                                                                                                                             
{
    Begin Object Class=SpriteEmitter Name=CheatDeathSpriteEmitter
        ...
        Texture=Texture'KFTurboCardGame.Effects.CheatedDeath_D'
        ...
        AutoDestroy=true
    End Object
    Emitters(0)=SpriteEmitter'CheatDeathSpriteEmitter'
