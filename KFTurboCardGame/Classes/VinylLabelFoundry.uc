...
defaultproperties
{
	...
	Begin Object Name=Default0 Class=TurboVinylBasic
		...
		VinylDescription="Increases damage by 5% for 5 seconds after killing a zed."
		SkinNameList(1)="KFTurboCardGame.Label.FOUNDRY_Default"
		AugmentList(0)=(Type=Damage,Multiplier=1.05f)
		AugmentInfoClass=class'VinylAugmentBasicKilled'
	...
	Begin Object Name=Default1 Class=TurboVinylBasic
		...
		VinylDescription="Increases fire rate by 10% for 5 seconds after killing a zed."
		SkinNameList(1)="KFTurboCardGame.Label.FOUNDRY_Default"
	...
	Begin Object Name=Default2 Class=TurboVinylBasic
		...
		VinylDescription="Increases reload rate by 10% for 5 seconds after killing a zed."
		SkinNameList(1)="KFTurboCardGame.Label.FOUNDRY_Default"
	...
	Begin Object Name=Default3 Class=TurboVinylBasic
		...
		VinylDescription="Increases movement speed by 5% for 5 seconds after killing a zed."
		SkinNameList(1)="KFTurboCardGame.Label.FOUNDRY_Default"
	...
	Begin Object Name=Support0 Class=TurboVinylBasic
		...
		VinylDescription="Increases weapon bullet penetration by 15% for 5 seconds after killing a zed."
		SkinNameList(1)="KFTurboCardGame.Label.FOUNDRY_Default"
	...
	Begin Object Name=Firebug0 Class=TurboVinylBasic
		...
		VinylDescription="Reduces fire damage taken by 15% for 5 seconds after killing a zed."
		SkinNameList(1)="KFTurboCardGame.Label.FOUNDRY_Default"
