...
defaultproperties
{
    ...
    mapIndexes(46)=(mapname="kf-crash-s",achvIndex=9)
    mapIndexes(47)=(mapname="kf-departed-s",achvIndex=10)
    mapIndexes(48)=(mapname="kf-departedwinter-s",achvIndex=10)
    mapIndexes(49)=(mapname="kf-evilsantaslair-s",achvIndex=17)
    mapIndexes(50)=(mapname="kf-forgotten-s",achvIndex=29)
    mapIndexes(51)=(mapname="kf-filthscross-s",achvIndex=11)
    mapIndexes(52)=(mapname="kf-foundry-s",achvIndex=5)
    mapIndexes(53)=(mapname="kf-hellride-s",achvIndex=21)
    mapIndexes(54)=(mapname="kf-hospitalhorrors-s",achvIndex=12)
    mapIndexes(55)=(mapname="kf-icebreaker-stirred",achvIndex=13)
    mapIndexes(56)=(mapname="kf-suburbia-s",achvIndex=15)
    mapIndexes(57)=(mapname="kf-waterworks-s",achvIndex=16)
    mapIndexes(58)=(mapname="kf-westlondon-s",achvIndex=0)
    mapIndexes(59)=(mapname="kf-westlondonwinter-s",achvIndex=0)
