//Killing Floor Turbo W_V_SealSqueal_Vet_Weap
//Distributed under the terms of the MIT License.
//For more information see https://github.com/KFPilot/KFTurbo.
class W_V_SealSqueal_Vet_Weap extends W_SealSqueal_Weap;
...
simulated function UpdateWeaponTier()
{
     ...
     {
          if (W_V_SealSqueal_Vet_Attachment(ThirdPersonActor) != None)
          {
               W_V_SealSqueal_Vet_Attachment(ThirdPersonActor).SetWeaponTier(WeaponTier);
          }
     }
...
defaultproperties
{
     ItemName="Neon SealSqueal Harpoon Bomber"
     SkinRefs(0)="KFTurbo.SealSqueal.SealSqueal_Vet_SHDR"
     PickupClass=Class'KFTurbo.W_V_SealSqueal_Vet_Pickup'
     AttachmentClass=Class'KFTurbo.W_V_SealSqueal_Vet_Attachment'
}
