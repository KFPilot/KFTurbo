//Killing Floor Turbo W_V_KSG_Vet_Weap
//Distributed under the terms of the MIT License.
//For more information see https://github.com/KFPilot/KFTurbo.
class W_V_KSG_Vet_Weap extends W_KSG_Weap;
...
simulated function UpdateWeaponTier()
{
     ...
     {
          if (W_V_KSG_Vet_Attachment(ThirdPersonActor) != None)
          {
               W_V_KSG_Vet_Attachment(ThirdPersonActor).SetWeaponTier(WeaponTier);
          }
     }
