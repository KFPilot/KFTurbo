...
defaultproperties
{
    ...
    ReplacementList(5)=(TargetParentClass=class'P_Clot',ReplacementClass=class'P_Clot_Undead',ChanceToReplace=0.1f)
    ReplacementList(6)=(TargetParentClass=class'P_Husk',ReplacementClass=class'P_Husk_Shotgun',ChanceToReplace=0.1f)
    //ReplacementList(7)=(TargetParentClass=class'P_Stalker',ReplacementClass=class'P_Stalker_Wraith',ChanceToReplace=0.9f)
}