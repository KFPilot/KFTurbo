...
class W_V_Boomstick_Vet_Attachment extends WeaponBoomStickAttachment;
...
{
     local W_V_Boomstick_Vet_Attachment WeaponAttachment;
	...
	class'VetWeaponHelper'.static.PreloadVeterancyAttachmentAssets(Spawned, default.LoadedStateMaterialRefList, default.LoadedStateMaterialList);
     ...
     WeaponAttachment = W_V_Boomstick_Vet_Attachment(Spawned);
...
defaultproperties
{
	...
	LoadedStateMaterialRefList(0)="KFTurbo.VetTiers.Boomstick_Vet_3rd_Red_SHDR"
	LoadedStateMaterialRefList(1)="KFTurbo.VetTiers.Boomstick_Vet_3rd_Green_SHDR"
	LoadedStateMaterialRefList(2)="KFTurbo.VetTiers.Boomstick_Vet_3rd_Blue_SHDR"
	LoadedStateMaterialRefList(3)="KFTurbo.VetTiers.Boomstick_Vet_3rd_Pink_SHDR"
	LoadedStateMaterialRefList(4)="KFTurbo.VetTiers.Boomstick_Vet_3rd_Purple_SHDR"
	LoadedStateMaterialRefList(5)="KFTurbo.VetTiers.Boomstick_Vet_3rd_Orange_SHDR"
	LoadedStateMaterialRefList(6)="KFTurbo.VetTiers.Boomstick_Vet_3rd_Gold_SHDR"
	LoadedStateMaterialRefList(7)="KFTurbo.VetTiers.Boomstick_Vet_3rd_Plat_SHDR"
     LoadedStateMaterialRefList(8)="KFTurbo.VetTiers.Boomstick_Vet_3rd_Rainbow_SHDR"

	Skins(0)=Shader'KFTurbo.Vet.Boomstick_Vet_3rd_SHDR'
}