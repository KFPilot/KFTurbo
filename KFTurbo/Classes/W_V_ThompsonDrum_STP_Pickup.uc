//Killing Floor Turbo W_V_ThompsonDrum_STP_Pickup
//Distributed under the terms of the MIT License.
//For more information see https://github.com/KFPilot/KFTurbo.
class W_V_ThompsonDrum_STP_Pickup extends W_ThompsonDrum_Pickup;

defaultproperties
{
    InventoryType=Class'KFTurbo.W_V_ThompsonDrum_STP_Weap'
