//Killing Floor Turbo W_V_MAC10_Vet_Attachment
//Distributed under the terms of the MIT License.
//For more information see https://github.com/KFPilot/KFTurbo.
class W_V_MAC10_Vet_Attachment extends WeaponMAC10Attachment;
...
{
     local W_V_MAC10_Vet_Attachment WeaponAttachment;
	...
	class'VetWeaponHelper'.static.PreloadVeterancyAttachmentAssets(Spawned, default.LoadedStateMaterialRefList, default.LoadedStateMaterialList);
     ...
     WeaponAttachment = W_V_MAC10_Vet_Attachment(Spawned);
...
defaultproperties
{
	bNetNotify=true
     ...
     LoadedStateMaterialRefList(0)="KFTurbo.VetTiers.MAC10_Vet_3rd_Red_SHDR"
     LoadedStateMaterialRefList(1)="KFTurbo.VetTiers.MAC10_Vet_3rd_Green_SHDR"
     LoadedStateMaterialRefList(2)="KFTurbo.VetTiers.MAC10_Vet_3rd_Blue_SHDR"
     LoadedStateMaterialRefList(3)="KFTurbo.VetTiers.MAC10_Vet_3rd_Pink_SHDR"
     LoadedStateMaterialRefList(4)="KFTurbo.VetTiers.MAC10_Vet_3rd_Purple_SHDR"
     LoadedStateMaterialRefList(5)="KFTurbo.VetTiers.MAC10_Vet_3rd_Orange_SHDR"
     LoadedStateMaterialRefList(6)="KFTurbo.VetTiers.MAC10_Vet_3rd_Gold_SHDR"
     LoadedStateMaterialRefList(7)="KFTurbo.VetTiers.MAC10_Vet_3rd_Plat_SHDR"
     LoadedStateMaterialRefList(8)="KFTurbo.VetTiers.MAC10_Vet_3rd_Rainbow_SHDR"

     Skins(0)=Shader'KFTurbo.Vet.MAC10_Vet_3rd_SHDR'
}
