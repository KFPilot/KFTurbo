//Killing Floor Turbo W_V_Machete_Vet_Weap
//Distributed under the terms of the MIT License.
//For more information see https://github.com/KFPilot/KFTurbo.
class W_V_Machete_Vet_Weap extends W_Machete_Weap;
...
simulated function UpdateWeaponTier()
{
     ...
     {
          if (W_V_Machete_Vet_Attachment(ThirdPersonActor) != None)
          {
               W_V_Machete_Vet_Attachment(ThirdPersonActor).SetWeaponTier(WeaponTier);
          }
     }
...
defaultproperties
{
     ...
     SkinRefs(0)="KFTurbo.Machete.Machete_Vet_SHDR"
     BloodyMaterialRef="KFTurbo.Machete.Machete_Bloody_Vet_SHDR"

     PickupClass=Class'KFTurbo.W_V_Machete_Vet_Pickup'
     AttachmentClass=Class'KFTurbo.W_V_Machete_Vet_Attachment'
}
