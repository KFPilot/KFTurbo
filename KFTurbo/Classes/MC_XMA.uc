...
defaultproperties
{
     ...
     StandardMonsterClasses(4)=(MClassName="KFTurbo.P_Scrake_XMA")
     ...
     ShortSpecialSquads(2)=(ZedClass=("KFTurbo.P_Crawler_XMA","KFTurbo.P_Gorefast_XMA","KFTurbo.P_Stalker_XMA","KFTurbo.P_Scrake_XMA"))
     ShortSpecialSquads(3)=(ZedClass=("KFTurbo.P_Bloat_XMA","KFTurbo.P_Siren_XMA","KFTurbo.P_Fleshpound_XMA"))
     NormalSpecialSquads(3)=(ZedClass=("KFTurbo.P_Crawler_XMA","KFTurbo.P_Gorefast_XMA","KFTurbo.P_Stalker_XMA","KFTurbo.P_Scrake_XMA"))
     ...
     LongSpecialSquads(9)=(ZedClass=("KFTurbo.P_Bloat_XMA","KFTurbo.P_Siren_XMA","KFTurbo.P_Scrake_XMA","KFTurbo.P_Fleshpound_XMA"))
